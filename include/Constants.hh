...
// O-Ring (rectangular shape assumed)
  ...
  constexpr auto kENCL_Bot_Ysize = kENCL_Bot_Xsize; //162.0*mm;
 ...
 //--------------------------------------------------------------
  ...
  constexpr auto kPayload_Module_Zsize = 344.1*mm; // note - top plate sits just above the top of this module (brings total z to 346.27*mm)
